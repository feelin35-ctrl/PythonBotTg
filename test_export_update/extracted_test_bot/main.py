...
# -*- coding: utf-8 -*-
"""
Деплоймент бота "test_simple" для хостинга
...
def run_bot():
    ...
    while True:
        try:
            ...
            bot_token = tokens.get("test_simple")
            if not bot_token:
            ...
            def handle_start(message):
                try:
                    ...
                    bot.send_message(message.chat.id, "Hello! This is a test bot with auto-update functionality.")
